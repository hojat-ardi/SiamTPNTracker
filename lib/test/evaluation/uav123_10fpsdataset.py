...
class UAV123_10fpsDataset(BaseDataset):
    ...
    def _get_sequence_list(self):
        ...
        if self.split != 'all':
            # اگر در آینده نیاز به پارتیشن‌بندی دارید، می‌توانید این بخش را توسعه دهید
            # برای مثال:
            # if self.split == 'train':
            #     # انتخاب زیرمجموعه‌ای از توالی‌ها برای آموزش
            # elif self.split == 'val':
            #     # انتخاب زیرمجموعه‌ای از توالی‌ها برای اعتبارسنجی
            pass  # در حال حاضر، همه توالی‌ها را برمی‌گرداند
